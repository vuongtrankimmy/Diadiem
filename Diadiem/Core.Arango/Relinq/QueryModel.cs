...
namespace Core.Arango.Relinq
{
    ...
    internal sealed class QueryModel
    {
        ...
        private void ResultOperators_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            _ = ArgumentUtility.CheckItemsNotNullAndType("e.NewItems", e.NewItems, typeof(ResultOperatorBase));
        }
        ...
        {
            ArgumentUtility.CheckNotNull("e", e);
            _ = ArgumentUtility.CheckItemsNotNullAndType("e.NewItems",
                                                         e.NewItems,
                                                         typeof(IBodyClause));
        ...
        public bool IsIdentityQuery()
        {
            return BodyClauses.Count == 0
                   && SelectClause.Selector is QuerySourceReferenceExpression expression
                   && expression.ReferencedQuerySource == MainFromClause;
        }
        ...
        public QueryModel ConvertToSubQuery(string itemName)
        {
            ...
            if (GetOutputDataInfo() is not StreamedSequenceInfo outputDataInfo)
            {
