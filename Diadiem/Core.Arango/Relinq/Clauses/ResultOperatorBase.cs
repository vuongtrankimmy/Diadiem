    ...
    internal abstract class ResultOperatorBase
    {
        ...
        public void Accept(IQueryModelVisitor visitor, QueryModel queryModel, int index)
        {
            ...
            if (this is AsQueryableResultOperator &&
                visitor is not AsQueryableResultOperator.ISupportedByIQueryModelVistor)
                return;
        ...
        /// </returns>
        protected static T GetConstantValueFromExpression<T>(string expressionName, Expression expression)
        {
            ...
            if (expression is ConstantExpression itemAsConstantExpression)
            {
        ...
        protected static void CheckSequenceItemType(StreamedSequenceInfo inputInfo, Type expectedItemType)
        {
            if (!expectedItemType.GetTypeInfo().IsAssignableFrom(inputInfo.ResultItemType.GetTypeInfo()))
            {
                ...
                throw new ArgumentException(message, nameof(inputInfo));
            }
        }
    }
}